...
private TableView tableview;
 ...
 @FXML
    ...
    private void handleEkle(ActionEvent event){
      ...
      preparedStmt.setString (2,txttc.getText().toString());//? ile belirttiğimiz değer. 
      ...
      txtad.setText("");
      txtid.setText("");//txtadi temizliyoruz. 
      txttc.setText("");
      txtemail.setText("");
    ...
    private void handleSil(ActionEvent event){
        ...
        try{
        c = (Connection) DB.connect();
        String query = "delete from bilgi where id=?"; //sqlimizi yazıyoruz. Değeri aşağıda tanımlayacağız. 

      PreparedStatement preparedStmt = c.prepareStatement(query);
      preparedStmt.setString (1,txtid.getText().toString());//? ile belirttiğimiz değer. 
      preparedStmt.execute();//komutu çalıştırıyoruz
      tablodoldur();//tablomuzu yeniliyoruz. 
      txtid.setText("");//txtadi temizliyoruz. 
